...
id = ['32386501', '330533740', '668829403', '856370061', '415327085', '27014522', '407428821', '960625306', '218127036']

bot = telebot.TeleBot('5762744134:AAGrgvZPcvn1hpu-1PKGJKPY0zQFNo9hLaI')
                ...
                if '#SHORT' in new_message or '#LONG' in new_message:
                    ...
                    if 'Take Profit' in new_message:
                        ...
                        try:
                            ...
                            order_andrey(symbol, side, qty_m, qty_2, qty_3, count_l, stop_loss, st_one, st_two, tk3)
                            order_ignat_1(symbol, side, stop_loss, count_l, qty_m_ignat, qty_2_ignat, qty_3_ignat, st_one,  st_two, tk3)
                            order_maks_1(symbol, side, stop_loss, count_l, qty_m_maks, qty_2_maks, qty_3_maks, st_one, st_two, tk3)
                            ...
                            for i in id:
                                try:
                                    bot.send_message(i, f"{new_message}")
                                except Exception as e:
                                    print(e)
                        except Exception as e:
                            if x == 1:
